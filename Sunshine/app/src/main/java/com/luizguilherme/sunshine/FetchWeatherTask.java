...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                mContext.getString(R.string.pref_key_temperature_unit),
                mContext.getString(R.string.pref_default_temperature_unit));

        if (unitType.equals(mContext.getString(R.string.temperature_unit_value_imperial))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.temperature_unit_value_metric))) {
